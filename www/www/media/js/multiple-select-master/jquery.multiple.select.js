...
(function($) {
	...
	function MultipleSelect($el, options) {
		...
		this.$parent = $('<div class="ms-parent" style="margin:0"></div>');
		...
		this.$drop.css({
			width: (options.width || elWidth+100) + 'px'
		});
	...
	MultipleSelect.prototype = {
		...
		init: function() {
			...
			this.$drop.find('.multiple').css('min-width', this.options.multipleWidth + 'px');
